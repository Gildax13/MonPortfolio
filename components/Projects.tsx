          ...
          >
            <div className="flex-row flex mb-5">
              ...
              <div className="p-3">
                ...
                <p className="text-gray-500 text-[10px]">
                  Développement des sites internet vitrines, teaser et boutique majoritairement en HTML, CSS, JS afin de mettre en valeur les caractéristiques du Berclet.
                </p>
              </div>
            </div>
          </Link>
